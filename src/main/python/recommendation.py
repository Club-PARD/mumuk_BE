...
food_categories = {
    ...
    'japaneseFood': [
        ...
        "스키야키/샤브샤브", "카레", "장어덮밥", "연어 덮밥", "텐동", "연어포케", "오코노미야끼",
    ...
    'carbohydrate': [
        ...
        "햄버거", "피자", "샌드위치", "장어덮밥", "연어 덮밥", "텐동", "알밥", "떡만두국",
    ...
    'redFood': [
        ...
        "마파두부", "똠양꿍", "김치전", "뼈 해장국", "뽈찜"
    ],
    'nonRedFood': [
        "한정식", "간장치킨", "로제떡볶이", "죽", "도시락", "칼국수", "냉면", "밀면", "잔치국수", "족발", "보쌈", "구이",
        ...
        "산낙지", "불고기전골", "후토마끼", "카츠샌도", "오무라이스", "청국장", "버섯전골", "로제파스타", "비지찌개"
    ],
    'rice': [
        ...
        "장어덮밥", "연어 덮밥", "텐동", "알밥", "선지국", "두부김치", "연어포케", "비지찌개",
    ...
    'noodle': [
        ...
        "알리올리오", "콩국수", "마제소바", "열무국수", "마라샹궈", "분짜", "뇨끼", "막국수", "파스타", "스파게티"
    ],
    'heavy': [
    ...
    'light': [
        ...
        "반미", "분짜", "갈치구이", "장어덮밥", "버섯전골", "카츠샌도", "후토마끼", "스파게티", "까르보나라 파스타"
    ],
    'soup': [
    ...
    'noSoup': [
        ...
        "로제떡볶이", "장어덮밥", "연어 덮밥", "알밥", "두부김치", "오리훈제", "매운등갈비", "뽈찜",
        "굴비구이", "폭립", "오코노미야끼", "마라샹궈", "반미", "분짜", "갈치구이", "카츠샌도",
        "후토마끼", "오무라이스", "까르보나라 파스타"
    ]
}
...
exceptional_foods = {
    ...
    '유제품': ['까르보나라 파스타', '로제파스타', '피자', '브리또', '샌드위치', '토스트'],
    '견과류': ['한정식'],
    ...
    '생선': ['생선구이', '생선 조림', '아구찜', '회', '물회', '고등어구이', '고등어조림', '갈치조림', '알탕', '동태찌개', '장어덮밥', '연어 덮밥', '알밥', '연어포케', '추어탕', '뽈찜', '굴비구이', '황태국', '갈치구이', '장어덮밥', '후토마끼'],
    '콩': ['된장찌개', '청국장', '두부김치', '비지찌개'],
    '밀가루': ['까르보나라 파스타', '로제파스타', '칼국수', '냉면', '비빔냉면', '밀면', '잔치국수', '쫄면', '짜장면', '중국식볶음밥', '파스타', '라멘', '우동', '스키야키/샤브샤브', '타코', '탕수육', '깐풍기', '튀김', '돈가스', '브리또', '샌드위치', '햄버거', '토스트', '떡볶이', '로제떡볶이', '오뎅', '유부초밥', '콩국수', '마제소바', '부대찌개', '텐동', '열무국수', '오코노미야끼', '마라샹궈', '오무라이스', '스파게티']
}
...
# 매운 음식 선호도
spicy_foods = {
    '매운 거 잘 먹는 사람': ['비빔냉면', '매운찜닭', '낙곱새', '쭈꾸미볶음', '낙지볶음', '김치찌개', '떡볶이', '김치볶음밥', '매운탕', '꽃게탕', '닭볶음탕', '마파두부', '육개장', '순두부찌개', '짬뽕', '마라탕', '훠궈', '닭발', '불족발', '해물찜', '닭갈비', '동태찌개', '선지국', '두부김치', '매운등갈비', '뽈찜', '마라샹궈', '로제떡볶이', '제육볶음'],
    '매운 거 못 먹는 사람': ['스파게티','한정식', '죽', '도시락', '칼국수', '냉면', '밀면', '잔치국수', '족발', '보쌈', '구이', '돼지갈비', '닭갈비', '오리고기', '불고기', '제육볶음', '막창', '곱창', '대창', '치킨', '찜닭', '로제찜닭', '곱창전골', '해물 전골', '불고기 전골', '된장찌개', '순대국밥', '삼계탕', '갈비찜', '떡국', '해물탕', '청국장', '감자탕', '순대', '튀김', '쫄면', '오뎅', '김밥', '간장게장', '생선구이', '생선 조림', '아구찜', '생선', '육회', '회', '물회', '짜장면', '중국식볶음밥', '마파두부', '딤섬', '양꼬치', '피자', '햄버거', '샌드위치', '토스트', '브리또', '파스타', '로제파스타', '까르보나라 파스타', '알리올리오', '샐러드', '스테이크', '필라프', '초밥/스시', '라멘', '덮밥', '메밀소바', '돈가스', '우동', '스키야키/샤브샤브', '카레', '쌀국수', '난', '똠양꿍', '팟타이', '나시고랭', '미고랭', '타코', '탕수육', '깐풍기', '해물파전', '콩나물국밥', '양장피', '유산슬', '양고기', '막국수', '돼지국밥', '미역국', '곰탕', '설렁탕', '간장치킨', '소불고기', '갈치조림', '고등어조림', '김치찜', '소갈비찜', '떡갈비', '삼겹살', '돼지갈비', '소고기', '장어구이', '조개구이', '황태국', '굴비구이', '도가니탕', '갈비탕', '부대찌개', '장어덮밥', '연어 덮밥', '알밥', '포케', '연어포케', '비지찌개', '추어탕', '열무국수', '오리훈제', '폭립', '오코노미야끼', '반미', '분짜', '갈치구이', '카츠샌도', '후토마끼', '리조또', '마제소바', '비빔밥', '유부초밥', '반쎄오', '떡만두국', '오무라이스', '김치볶음밥', '육개장', '순두부찌개']
}
...
def recommend_food():
    ...
    for user in users:
        ...
        if user['yesterdayFood']:
            ...
            # '로제'나 '크림'으로 시작하는 경우
            if user['yesterdayFood'].startswith('로제'):
                user_foods = {food for food in user_foods if not food.startswith('로제')}
            if user['yesterdayFood'].startswith('크림'):
                user_foods = {food for food in user_foods if not food.startswith('크림')}
