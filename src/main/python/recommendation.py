...
# 전체 음식 목록
all_foods = [
    "비빔밥", "한정식", "죽", "도시락", "칼국수", "냉면", "비빔냉면", "밀면", "잔치국수",
...
food_categories = {
    'koreanFood': [
        ...
        "조개구이", "닭볶음탕", "내장탕", "뼈 해장국", "콩국수", "알탕", "갈비탕", "내장국밥",
        "닭칼국수", "조기구이", "갈치 구이", "산낙지"
    ],
    'chineseFood': [
    ...
    'japaneseFood': [
        "초밥/스시", "유부초밥", "라멘", "덮밥", "메밀소바", "튀김", "돈가스", "우동",
        "스키야키/샤브샤브", "카레", "장어덮밥", "연어덮밥", "텐동", "연어포케", "오코노미야끼",
        "마제소바", "포케", "튀김 덮밥", "카츠샌도", "후토마끼", "오무라이스"
    ],
    'southeastAsianFood': [
    ...
    'meat': [
        "돼지국밥", "뼈해장국", "해장국", "설렁탕", "삼계탕", "갈비찜", "육회", "스테이크", "돈가스",
    ...
    'carbohydrate': [
        "육회비빔밥", "산채비빔밥", "정식", "죽", "도시락", "칼국수", "냉면", "잔치국수",
        "김치찌개", "된장찌개", "돼지국밥", "뼈해장국", "콩나물국밥", "설렁탕", "육개장",
        "떡국", "청국장", "감자탕", "떡볶이", "비빔냉면", "밀면", "쫄면", "짬뽕", "짜장면",
        "마파두부", "딤섬", "라멘", "우동", "메밀소바", "쌀국수", "팟타이", "미고랭",
        "로제파스타", "파스타", "까르보나라 파스타", "알리올리오 파스타", "콩국수", "마제소바",
        "비빔밥", "한정식", "순대국밥", "해물탕", "순대", "오뎅", "김밥", "중국식볶음밥",
        ...
        "나시고랭", "닭칼국수", "순두부찌개", "튀김", "마라탕", "양장피", "오무라이스"
    ],
    'seafood': [
        "낙곱새", "해물 전골", "쭈꾸미 볶음", "낙지 볶음", "해물탕", "게장",
        "생선구이", "생선조림", "아구찜", "회", "육회", "물회", "초밥/스시",
    ...
    'redFood': [
        ...
        "매운탕", "청국장", "떡볶이", "로제떡볶이", "양념게장", "아구찜", "김치찜",
        "김치볶음밥", "두부김치", "비지찌개", "닭발", "불족발", "간장치킨", "양념치킨",
        "닭볶음탕", "내장탕", "매운등갈비", "오징어볶음", "해물찜", "부대찌개", "동태찌개",
        "황태국", "버섯전골", "마라샹궈", "짬뽕", "해물탕", "닭갈비", "꽃게탕", "쫄면",
        "마파두부", "로제파스타", "똠양꿍", "김치전", "뼈 해장국", "뽈찜"
    ],
    'nonRedFoods': [
        "한정식", "죽", "도시락", "칼국수", "냉면", "밀면", "잔치국수", "족발", "보쌈", "구이",
        "돼지갈비", "닭갈비", "오리고기", "불고기", "막창", "곱창", "대창", "치킨", "찜닭",
        "순대국밥", "삼계탕", "갈비찜", "떡국", "감자탕", "순대", "튀김", "쫄면", "오뎅", "김밥",
        "간장게장", "생선구이", "생선 조림", "생선", "육회", "회", "물회", "짜장면", "중국식볶음밥",
        "딤섬", "마라탕", "훠궈", "양꼬치", "피자", "햄버거", "샌드위치", "토스트", "브리또",
        "파스타", "까르보나라 파스타", "스파게티", "알리올리오", "샐러드", "스테이크", "필라프",
        "초밥/스시", "유부초밥", "라멘", "덮밥", "메밀소바", "돈가스", "우동", "스키야키/샤브샤브",
        "카레", "쌀국수", "난", "팟타이", "나시고랭", "미고랭", "타코", "탕수육", "깐풍기", "파전",
        "해물파전", "콩나물국밥", "육회비빔밥", "양장피", "된장찌개", "유산슬", "양고기", "막국수",
        "돼지국밥", "미역국", "곰탕", "설렁탕", "소불고기", "갈치조림", "고등어조림", "고등어구이",
        "소갈비찜", "떡갈비", "삼겹살", "소고기", "장어구이", "조개구이", "콩국수", "알탕", "갈비탕",
        "리조또", "마제소바", "포케", "연어포케", "내장국밥", "연어 덮밥", "튀김 덮밥",
        "알밥", "떡만두국", "선지국", "추어탕", "열무국수", "오리훈제", "닭칼국수", "도가니탕",
        "굴비구이", "조기구이", "폭립", "뇨끼", "오코노미야끼", "반미", "분짜", "반쎄오", "갈치 구이",
        "산낙지", "불고기전골", "후토마끼", "카츠샌도", "오무라이스"
    ],
    'rice': [
        ...
        "생선구이", "생선 조림", "아구찜", "생선", "육회", "회", "물회", "중국식볶음밥",
        "김치볶음밥", "샐러드", "초밥/스시", "덮밥", "필라프", "유산슬", "콩나물국밥", "해물찜",
        "돼지국밥", "곰탕", "설렁탕", "떡갈비", "삼겹살", "소고기", "장어구이", "조개구이",
        "양장피", "미역국", "고등어조림", "갈치조림", "닭볶음탕", "유부초밥", "내장탕",
        "뼈 해장국", "알탕", "갈비탕", "리조또", "추어탕", "떡만두국", "부대찌개", "동태찌개",
        ...
        "포케", "내장국밥", "튀김 덮밥", "오리훈제", "닭칼국수", "뽈찜", "조기구이", "폭립",
        "오무라이스"
    ],
    'bread': [
    ...
    'noodle': [
        "칼국수", "냉면", "비빔냉면", "밀면", "잔치국수", "쫄면", "짬뽕", "짜장면",
        "마파두부", "딤섬", "마라탕", "훠궈", "양꼬치", "라멘", "우동", "메밀소바",
        "스키야키/샤브샤브", "쌀국수", "팟타이", "미고랭", "로제파스타", "까르보나라 파스타",
        "알리올리오 파스타", "콩국수", "마제소바", "열무국수", "마라샹궈", "분짜", "뇨끼"
    ],
    'heavy': [
        ...
        "유산슬", "해물찜", "떡볶이", "로제떡볶이", "내장탕", "뼈 해장국", "콩국수", "알탕",
        "갈비탕", "부대찌개", "동태찌개", "연어덮밥", "텐동", "떡만두국", "선지국", "비지찌개",
        "똠양꿍", "추어탕", "오리훈제", "매운등갈비", "도가니탕", "뽈찜", "폭립", "오코노미야끼",
        "마라샹궈", "쭈꾸미볶음", "양념게장", "간장게장", "중국식볶음밥", "돈가스", "나시고랭",
        "김치전", "해물파전", "오징어볶음", "육회비빔밥", "양고기", "돼지국밥", "순두부찌개",
        "양념치킨", "반쎄오", "갈치 구이", "산낙지", "오무라이스"
    ],
    'light': [
        "죽", "도시락", "샐러드", "김밥", "오뎅", "콩나물국밥", "초밥/스시", "샌드위치",
    ...
    'soup': [
        ...
        "훠궈", "라멘", "우동", "스키야키/샤브샤브", "똠양꿍", "콩나물국밥", "냉면", "비빔냉면",
...
exceptional_foods = {
    '내장류': ['곱창전골', '대창전골', '막창', '곱창', '대창', '낙곱새', '선지국', '도가니탕'],
    '날 것': ['회', '물회', '육회', '육회 비빔밥'],
    '해산물': ['낙곱새', '해물 전골', '쭈꾸미 볶음', '낙지 볶음', '해물탕', '게장', '생선구이', '생선조림', '아구찜', '회', '육회', '물회', '초밥/스시', '동태찌개', '장어덮밥', '추어탕', '뽈찜', '황태국', '굴비구이', '오코노미야끼', '갈치구이', '양념게장', '간장게장', '꽃게탕', '해물찜', '짬뽕', '훠궈'],
    '오이': ['비빔밥'],
    '계란': ['비빔밥', '한정식', '도시락', '김밥', '파전', '김치전', '해물파전', '떡갈비', '오코노미야끼', '카츠샌도', '후토마끼', '오무라이스'],
    '유제품': ['파스타', '까르보나라 파스타', '로제파스타', '피자', '브리또', '샌드위치', '토스트'],
    '견과류': ['한정식'],
    '갑각류': ['양념게장', '간장게장', '해물 전골', '해물탕', '꽃게탕', '아구찜', '해물찜', '짬뽕', '훠궈'],
    '육류': ['불고기', '제육볶음', '돼지갈비', '닭갈비', '오리고기', '막창', '곱창', '대창', '찜닭', '매운찜닭', '로제찜닭', '낙곱새', '곱창전골', '불고기 전골', '삼계탕', '갈비찜', '육개장', '감자탕', '떡볶이', '순대', '튀김', '양꼬치', '햄버거', '샌드위치', '스테이크', '덮밥', '돈가스', '소불고기', '양고기', '돼지국밥', '설렁탕', '닭발', '불족발', '간장치킨', '삼겹살', '닭볶음탕', '갈비탕', '부대찌개', '선지국', '오리훈제', '매운등갈비', '도가니탕', '폭립'],
    '생선': ['생선구이', '생선 조림', '아구찜', '회', '물회', '고등어구이', '고등어조림', '갈치조림', '알탕', '동태찌개', '장어덮밥', '연어덮밥', '알밥', '연어포케', '추어탕', '뽈찜', '굴비구이', '황태국', '갈치구이', '장어덮밥', '후토마끼'],
    '콩': ['된장찌개', '청국장', '두부김치', '비지찌개'],
    '밀가루': ['칼국수', '냉면', '비빔냉면', '밀면', '잔치국수', '쫄면', '짜장면', '중국식볶음밥', '파스타', '라멘', '우동', '스키야키/샤브샤브', '타코', '탕수육', '깐풍기', '튀김', '돈가스', '브리또', '샌드위치', '햄버거', '토스트', '떡볶이', '로제떡볶이', '오뎅', '유부초밥', '콩국수', '마제소바', '부대찌개', '텐동', '열무국수', '오코노미야끼', '마라샹궈', '오무라이스']
}

# 식단 관련 정보
diet_types = {
    '비건': ['샐러드', '김밥(야채)', '비빔밥(야채)', '나시고랭(야채)', '백반', '두부조림', '두부 샐러드', '퀴노아 샐러드', '비건 버거', '비건 파스타', '두부김치', '비지찌개', '반미', '버섯전골'],
    '할랄': ['비빔밥', '한정식', '죽', '도시락', '칼국수', '냉면', '비빔냉면', '밀면', '잔치국수', '오리고기', '치킨', '낙곱새', '해물 전골', '불고기 전골', '쭈꾸미볶음', '낙지볶음', '된장찌개', '삼계탕', '육개장', '떡국', '해물탕', '청국장', '감자탕', '떡볶이', '튀김', '쫄면', '오뎅', '김밥', '양념게장', '간장게장', '생선구이', '생선 조림', '아구찜', '생선', '육회', '회', '물회', '짜장면', '중국식볶음밥', '마파두부', '딤섬', '마라탕', '훠궈', '양꼬치', '샌드위치', '토스트', '브리또', '파스타', '로제파스타', '까르보나라 파스타', '스파게티', '알리올리오', '샐러드', '스테이크', '초밥/스시', '메밀소바', '우동', '스키야키/샤브샤브', '카레', '쌀국수', '난', '똠양꿍', '팟타이', '나시고랭', '미고랭', '타코', '탕수육', '깐풍기', '파전', '김치전', '해물파전', '콩나물국밥', '오징어볶음', '육회비빔밥', '양장피', '유산슬', '양고기', '막국수', '해물찜', '순두부찌개', '매운탕', '꽃게탕', '미역국', '곰탕', '설렁탕', '간장치킨', '소불고기', '갈치조림', '고등어조림', '갈치구이', '고등어구이', '김치찜', '소갈비찜', '장어구이', '조개구이', '닭볶음탕', '갈비탕', '비지찌개', '열무국수', '오리훈제', '황태국', '오코노미야끼'],
    '다이어트': ['샐러드', '나물반찬', '구운 생선', '미역국', '메밀소바', '쌀국수', '비빔밥', '샌드위치', '브리또', '도시락', '샤브샤브', '두부김치', '포케', '연어포케', '죽', '한정식', '나물밥', '된장찌개', '해물탕', '청국장', '콩나물국밥', '알밥', '굴비구이', '황태국', '반미', '분짜', '버섯전골']
}

# 매운 음식 선호도
spicy_foods = {
    '매운 거 잘 먹는 사람': ['비빔냉면', '매운찜닭', '낙곱새', '쭈꾸미볶음', '낙지볶음', '김치찌개', '떡볶이', '김치볶음밥', '매운탕', '꽃게탕', '닭볶음탕', '육개장', '순두부찌개', '짬뽕', '마라탕', '훠궈', '닭발', '불족발', '해물찜', '닭갈비', '동태찌개', '선지국', '두부김치', '매운등갈비', '뽈찜', '마라샹궈', '로제떡볶이'],
    '매운 거 못 먹는 사람': ['한정식', '죽', '도시락', '칼국수', '냉면', '밀면', '잔치국수', '족발', '보쌈', '구이', '돼지갈비', '닭갈비', '오리고기', '불고기', '제육볶음', '막창', '곱창', '대창', '치킨', '찜닭', '로제찜닭', '곱창전골', '해물 전골', '불고기 전골', '된장찌개', '순대국밥', '삼계탕', '갈비찜', '떡국', '해물탕', '청국장', '감자탕', '순대', '튀김', '쫄면', '오뎅', '김밥', '간장게장', '생선구이', '생선 조림', '아구찜', '생선', '육회', '회', '물회', '짜장면', '중국식볶음밥', '마파두부', '딤섬', '양꼬치', '피자', '햄버거', '샌드위치', '토스트', '브리또', '파스타', '로제파스타', '까르보나라 파스타', '알리올리오', '샐러드', '스테이크', '필라프', '초밥/스시', '라멘', '덮밥', '메밀소바', '돈가스', '우동', '스키야키/샤브샤브', '카레', '쌀국수', '난', '똠양꿍', '팟타이', '나시고랭', '미고랭', '타코', '탕수육', '깐풍기', '해물파전', '콩나물국밥', '양장피', '유산슬', '양고기', '막국수', '돼지국밥', '미역국', '곰탕', '설렁탕', '간장치킨', '소불고기', '갈치조림', '고등어조림', '김치찜', '소갈비찜', '떡갈비', '삼겹살', '돼지갈비', '소고기', '장어구이', '조개구이', '황태국', '굴비구이', '도가니탕', '갈비탕', '부대찌개', '장어덮밥', '연어덮밥', '알밥', '포케', '연어포케', '비지찌개', '추어탕', '열무국수', '오리훈제', '폭립', '오코노미야끼', '반미', '분짜', '갈치구이', '카츠샌도', '후토마끼', '리조또', '마제소바', '비빔밥', '유부초밥', '반쎄오', '떡만두국', '오무라이스']
}
...
def get_max_preference_category(users, food, categories):
    max_pref = -1
    max_cat = None
    for cat in categories:
        pref = calculate_category_preference(users, food, cat)
        if pref > max_pref:
            max_pref = pref
            max_cat = cat
    return max_cat, max_pref
...
def recommend_food():
    ...
    for i, (food, preference) in enumerate(sorted_foods[:3], 1):
        ...
        for group in category_groups:
            max_cat, max_pref = get_max_preference_category(users, food, group)
            food_data[f"{max_cat}_preference"] = max_pref
